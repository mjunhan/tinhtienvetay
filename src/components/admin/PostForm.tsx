            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-md border border-amber-100 p-8 space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Category */}
                        <div>
                            <label htmlFor="category_id" className="block text-sm font-semibold text-slate-900 mb-2">
                                Danh mục
                            </label>
                            <select
                                {...register("category_id")}
                                className="w-full px-4 py-3 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
                            />
                            <p className="mt-1 text-xs text-slate-500">Ví dụ: nhap-hang, kinh-nghiem, van-chuyen</p>
                        </div>
